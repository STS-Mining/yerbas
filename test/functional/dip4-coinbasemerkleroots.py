...
from test_framework.test_framework import MemeiumTestFramework
...
class LLMQCoinbaseCommitmentsTest(MemeiumTestFramework):
    def set_test_params(self):
        self.set_memeium_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as MemeiumTestFramework doesn't support this atm)
