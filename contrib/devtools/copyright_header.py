...
# Copyright (c) 2019 The Memeium developers
...
Arguments:
    <base_directory> - The base directory of a Memeium Core source code repository.
...
Arguments:
    <base_directory> - The base directory of Memeium Core source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The Memeium developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Memeium developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the Memeium Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Memeium
