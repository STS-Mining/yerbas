...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkIDString() == CBaseChainParams::MAIN) {
        ...
        case MMM:
            return QString("tMMM");
        case mMMM:
            return QString("mtMMM");
        case uMMM:
            return QString::fromUtf8("μtMMM");
        case weeds:
            return QString("tduffs");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkIDString() == CBaseChainParams::MAIN) {
        switch (unit) {
        case MMM:
            return QString("Memeium");
        case mMMM:
            return QString("Milli-Memeium (1 / 1" THIN_SP_UTF8 "000)");
        case uMMM:
            return QString("Micro-Memeium (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        case weeds:
            return QString("Ten Nano-Memeium (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MMM:
            return QString("TestMemeiums");
        case mMMM:
            return QString("Milli-TestMemeium (1 / 1" THIN_SP_UTF8 "000)");
        case uMMM:
            return QString("Micro-TestMemeium (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        case weeds:
            return QString("Ten Nano-TestMemeium (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
