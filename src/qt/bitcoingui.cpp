...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Memeium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and memeium: URIs)"));
    ...
    TransferAssetsAction->setStatusTip(tr("Transfer assets to MMM addresses"));
    ...
    aboutAction->setStatusTip(tr("Show information about Memeium Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Memeium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Memeium addresses"));
    ...
    openAction->setStatusTip(tr("Open a memeium: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Memeium command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createToolBars()
{
    ...
    if (walletFrame) {
        ...
        // Add Memeium logo on the right side
        QWidget* spacer = new QWidget();
        spacer->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
        toolbar->addWidget(spacer);

        QLabel* logoLabel = new QLabel();
        QPixmap logoPixmap(":/images/memeium_logo_toolbar");
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Memeium network", "", count));
    } else {
...
{
    QString strTitle = tr("Memeium Core"); // default title
...
void BitcoinGUI::checkAssets()
{
    ...
    if (AreAssetsDeployed()) {
        ...
        TransferAssetsAction->setToolTip(tr("Transfer assets to MMM addresses"));
