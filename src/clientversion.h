...
#error Client version information missing: version is not defined by memeium-config.h or in any other way
#endif
...
/**
 * memeiumd-res.rc includes this file, but it cannot cope with real c++ code.
