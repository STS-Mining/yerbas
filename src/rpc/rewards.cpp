...
UniValue requestsnapshot(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("requestsnapshot", "\"TRONCO\" 12345") + HelpExampleRpc("requestsnapshot", "\"PHATSTACKS\" 34987"));
...
UniValue getsnapshotrequest(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("getsnapshotrequest", "\"TRONCO\" 12345") + HelpExampleRpc("getsnapshotrequest", "\"PHATSTACKS\" 34987"));
...
UniValue listsnapshotrequests(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("listsnapshotrequests", "") + HelpExampleRpc("listsnapshotrequests", "\"TRONCO\" 345333"));
...
UniValue cancelsnapshotrequest(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("cancelsnapshotrequest", "\"TRONCO\" 12345") + HelpExampleRpc("cancelsnapshotrequest", "\"PHATSTACKS\" 34987"));
...
UniValue distributereward(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 4)
        throw std::runtime_error(
            ...
            "3. \"distribution_asset_name\"    (string, required) The name of the asset that will be distributed, or MMM\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("distributereward", "\"TRONCO\" 12345 \"MMM\" 1000") + HelpExampleCli("distributereward", "\"PHATSTACKS\" 12345 \"DIVIDENDS\" 1000 \"mwN7xC3yomYdvJuVXkVC7ymY9wNBjWNduD,n4Rf18edydDaRBh7t6gHUbuByLbWEoWUTg\"") + HelpExampleRpc("distributereward", "\"TRONCO\" 34987 \"DIVIDENDS\" 100000") + HelpExampleRpc("distributereward", "\"PHATSTACKS\" 34987 \"MMM\" 100000 \"mwN7xC3yomYdvJuVXkVC7ymY9wNBjWNduD,n4Rf18edydDaRBh7t6gHUbuByLbWEoWUTg\""));
    ...
    CAmount distribution_amount = AmountFromValue(request.params[3], (distribution_asset_name == "MMM"));
    ...
    if (request.params.size() > 5) {
        ...
        if (!change_address.empty() && !IsValidDestinationString(change_address))
            throw JSONRPCError(RPC_INVALID_PARAMETER, std::string("Invalid change address: Use a valid MMM address"));
    }
    ...
    if (distribution_asset_name != "MMM" && distribution_asset_name != "tMMM") {
...
UniValue getdistributestatus(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 4)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("getdistributestatus", "\"TRONCO\" 12345 \"MMM\" 1000") + HelpExampleCli("getdistributestatus", "\"PHATSTACKS\" 12345 \"DIVIDENDS\" 1000 \"mwN7xC3yomYdvJuVXkVC7ymY9wNBjWNduD,n4Rf18edydDaRBh7t6gHUbuByLbWEoWUTg\"") + HelpExampleRpc("getdistributestatus", "\"TRONCO\" 34987 \"DIVIDENDS\" 100000") + HelpExampleRpc("getdistributestatus", "\"PHATSTACKS\" 34987 \"MMM\" 100000 \"mwN7xC3yomYdvJuVXkVC7ymY9wNBjWNduD,n4Rf18edydDaRBh7t6gHUbuByLbWEoWUTg\""));
