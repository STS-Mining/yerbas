...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total memeium balance of the wallet\n"
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            ListLogCategories() + ".\n"
                                  ...
                                  " - \"memeium\" activates all Memeium-specific categories at once;\n"
                                  ...
                                  "\nExamples:\n" +
            HelpExampleCli("debug", "memeium") + HelpExampleRpc("debug", "memeium+net"));
...
public:
    ...
    DescribeAddressVisitor(CWallet* _pwallet) :
        pwallet(_pwallet) {}
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given memeium address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The memeium address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The memeium address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Memeium address and we have full public key:
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2) {
        std::string msg = "createmultisig nrequired [\"key\",...]\n"
                          ...
                          "2. \"keys\"       (string, required) A json array of keys which are memeium addresses or hex-encoded public keys\n"
                          "     [\n"
                          "       \"key\"    (string) memeium address or hex-encoded public key\n"
                          "       ,...\n"
                          "     ]\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The memeium address to use for the signature.\n"
...
static const CRPCCommand commands[] =
    {
        ...
        /* Memeium features */
        {"memeium", "mnsync", &mnsync, true, {}},
        {"memeium", "spork", &spork, true, {"value"}},
