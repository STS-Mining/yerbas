# Contributing to Memeium Core

The Memeium Core project operates an open contributor model where anyone is
...
- _Qt_ for changes to memeium-qt
...
- _Tests_ for changes to the unit tests or QA tests
...
[Translation Process](https://github.com/The-Memeium-Endeavor/memeium/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Memeium Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Memeium
Network Protocol consensus changes.

Whether a pull request is merged into Memeium Core rests with the project merge
...
Patches that change Memeium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Memeium consensus, it must have been
...
The review process is normally fairly responsive on the Memeium Core repository, however
...
The project leader is the release manager for each Memeium Core release.
